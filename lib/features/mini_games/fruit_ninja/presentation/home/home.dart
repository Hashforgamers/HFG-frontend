...
import 'package:hash/features/mini_games/fruit_ninja/common/widgets/text/simple_center_text.dart';
...
import 'package:hash/features/mini_games/fruit_ninja/presentation/home/widgets/game_mode_component.dart';
import 'package:hash/features/mini_games/fruit_ninja/presentation/home/widgets/tutorial_fruit_component.dart';
import 'package:hash/features/mini_games/fruit_ninja/main_router_game.dart';
...
class HomePage extends Component with HasGameReference<MainRouterGame> {
      ...
      addAll([
        ...
        TutorialFruitsListComponent(
          ...
          fruits: [
            ...
            TutorialFruitComponent(
              text: 'Cherry',
              imagePath: AppImages.cherry,
              isLeft: true,
            ),
            TutorialFruitComponent(
              text: 'Kiwi',
              imagePath: AppImages.kiwi,
              isLeft: true,
            ),
            TutorialFruitComponent(
              text: 'Orange',
        ...
        TutorialFruitsListComponent(
          ...
          fruits: [
            TutorialFruitComponent(
              text: 'Bomb',
              imagePath: AppImages.bomb,
              isLeft: false,
            ),
            TutorialFruitComponent(
              text: 'Flame',
              imagePath: AppImages.flame,
              isLeft: false,
            ),
            TutorialFruitComponent(
              text: 'Flutter',
              imagePath: AppImages.flutter,
              isLeft: false,
            ),
          ],
        )..position = Vector2(0, 50),
  ...
  void onGameResize(Vector2 size) {
    ...
    _tutorialRuleScore1Component.position = Vector2(
      game.size.x / 2,
      game.size.y - game.size.y / 3.9,
    );
    _tutorialRuleScore2Component.position = Vector2(
      game.size.x / 2,
      game.size.y - game.size.y / 5.1,
    );
    _tutorialRuleLose1Component.position = Vector2(
      game.size.x / 2,
      game.size.y / 5.1,
    );
    _tutorialRuleLose2Component.position = Vector2(
      game.size.x / 2,
      game.size.y / 3.9,
    );
