...
class _ProductDetailViewState extends State<ProductDetailView> {
  ...
  final GetProductByIdController controller = Get.put(GetProductByIdController());
                      ...
                      Container(
                        ...
                        decoration: ShapeDecoration(
                          ...
                          shape: ContinuousRectangleBorder(
                            borderRadius: BorderRadius.vertical(top: Radius.circular(104)),
                          ),
                        ),
                        child: Column(
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(color: Colors.grey, fontSize: 13, fontWeight: FontWeight.normal, decoration: TextDecoration.lineThrough),
                                    ),
                                    SizedBox(width: 10,),
                                    Text(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Icon(CupertinoIcons.bag_badge_plus, color: Colors.white),
              ),
            ],
          ),
        ),
  ...
  Widget _buildSpecifications(Product product) {
    return Column(
      ...
      children: [
        ...
        _buildSpecificationRow('Compatibility', product.electronic.compatibility),
        _buildSpecificationRow('Connectivity', product.electronic.connectivity),
        _buildSpecificationRow('Power Consumption', product.electronic.powerConsumption),
        _buildSpecificationRow('Dimensions (L x W x H)', '${product.dimensions.length} x ${product.dimensions.width} x ${product.dimensions.height} ${product.dimensions.unit}'),
        _buildSpecificationRow('Weight', '${product.weight.value} ${product.weight.unit}'),
      ],
    );
  }
