        ...
        return BottomNavigationBar(type: BottomNavigationBarType.fixed,
          ...
          items:  <BottomNavigationBarItem>[
            BottomNavigationBarItem(backgroundColor: Colors.black,
              ...
              label: '',
              activeIcon: Image.asset('assets/icons/home-02.png',scale: 2.5,color: Color(0xff00D701),),
            ),
            BottomNavigationBarItem(backgroundColor: Colors.black,
              icon: Image.asset('assets/icons/target-04.png',scale: 3,color: Colors.grey[800]),
              label: '',
              activeIcon: Image.asset('assets/icons/target-04.png',scale: 2.5,color: Color(0xff00D701),),
            ...
            BottomNavigationBarItem(backgroundColor: Colors.black,
              ...
              label: '',
              activeIcon: Image.asset('assets/icons/gaming-pad-01.png',scale:2.1,color:Color(0xff00D701),),

            ),
            BottomNavigationBarItem(backgroundColor: Colors.black,
              icon: Image.asset('assets/icons/shopping-bag-01.png',scale: 3,color: Colors.grey[800]),
              label: '',
              activeIcon: Image.asset('assets/icons/shopping-bag-01.png',scale: 2.5,color: Color(0xff00D701)),

            ),
            BottomNavigationBarItem(backgroundColor: Colors.black,
              icon: Image.asset('assets/icons/settings-02.png',scale: 3,color: Colors.grey[800]),
              label: '',
              activeIcon: Image.asset('assets/icons/settings-02.png',scale: 2.5,color: Color(0xff00D701)),
